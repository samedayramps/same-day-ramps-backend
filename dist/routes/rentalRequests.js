...
const rentalRequestController = __importStar(require("../controllers/rentalRequestController"));
...
router.post('/', validationMiddleware_1.validateRentalRequestCreation, asyncHandler(rentalRequestController.createRentalRequest));
